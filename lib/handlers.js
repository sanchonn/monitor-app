...
handlers.index = (data, callback) => {
  ...
  if (data.method === 'get') {
    ...
    const templateData = {
      ...
      'head.description': 'Free simple uptime monitoring for HTTP/HTTPS sites of all kinds. When your site goes down we\'ll send a text to ley you know.',
      'body.class': 'index',
    };
...
handlers.accountCreate = (data, callback) => {
  ...
  if (data.method === 'get') {
    ...
    // Read in a template as a string
    helpers.getTemplate('accountCreate', templateData, (errCreate, strCreate) => {
      if (!errCreate && strCreate) {
        ...
        helpers.addUniversalTemplates(strCreate, templateData, (errAddUniversal, strAddUniversal) => {
          if (!errAddUniversal && strAddUniversal) {
            ...
            callback(200, strAddUniversal, 'html');
          } else {
            callback(500, undefined, 'html');
          }
        });
...
handlers.sessionCreate = (data, callback) => {
  ...
  if (data.method === 'get') {
    ...
    // Read in a template as a string
    helpers.getTemplate('sessionCreate', templateData, (errCreate, strCreate) => {
      if (!errCreate && strCreate) {
        // Add the universal header and footer
        helpers.addUniversalTemplates(strCreate, templateData, (errAddUniversal, strAddUniversal) => {
          if (!errAddUniversal && strAddUniversal) {
...
handlers.sessionDeleted = (data, callback) => {
  ...
  if (data.method === 'get') {
    ...
    // Read in a template as a string
    helpers.getTemplate('sessionDeleted', templateData, (errCreate, strCreate) => {
      if (!errCreate && strCreate) {
        // Add the universal header and footer
        helpers.addUniversalTemplates(strCreate, templateData, (errAddUniversal, strAddUniversal) => {
          if (!errAddUniversal && strAddUniversal) {
...
handlers.accountEdit = (data, callback) => {
  ...
  if (data.method === 'get') {
    ...
    // Read in a template as a string
    helpers.getTemplate('accountEdit', templateData, (errCreate, strCreate) => {
      if (!errCreate && strCreate) {
        // Add the universal header and footer
        helpers.addUniversalTemplates(strCreate, templateData, (errAddUniversal, strAddUniversal) => {
          if (!errAddUniversal && strAddUniversal) {
...
handlers.accountDeleted = (data, callback) => {
  ...
  if (data.method === 'get') {
    ...
    // Read in a template as a string
    helpers.getTemplate('accountDeleted', templateData, (errCreate, strCreate) => {
      if (!errCreate && strCreate) {
        // Add the universal header and footer
        helpers.addUniversalTemplates(strCreate, templateData, (errAddUniversal, strAddUniversal) => {
          if (!errAddUniversal && strAddUniversal) {
...
handlers.checksCreate = (data, callback) => {
  ...
  if (data.method === 'get') {
    ...
    console.log('checksCreate');
    // Read in a template as a string
    helpers.getTemplate('checksCreate', templateData, (errCreate, strCreate) => {
      if (!errCreate && strCreate) {
        // Add the universal header and footer
        helpers.addUniversalTemplates(strCreate, templateData, (errAddUniversal, strAddUniversal) => {
          if (!errAddUniversal && strAddUniversal) {
...
handlers.checksList = (data, callback) => {
  ...
  if (data.method === 'get') {
    ...
    // Read in a template as a string
    helpers.getTemplate('checksList', templateData, (errCreate, strCreate) => {
      if (!errCreate && strCreate) {
        // Add the universal header and footer
        helpers.addUniversalTemplates(strCreate, templateData, (errAddUniversal, strAddUniversal) => {
          if (!errAddUniversal && strAddUniversal) {
...
handlers.checksEdit = (data, callback) => {
  ...
  if (data.method === 'get') {
    ...
    // Read in a template as a string
    helpers.getTemplate('checksEdit', templateData, (errCreate, strCreate) => {
      if (!errCreate && strCreate) {
        // Add the universal header and footer
        helpers.addUniversalTemplates(strCreate, templateData, (errAddUniversal, strAddUniversal) => {
          if (!errAddUniversal && strAddUniversal) {
...
handlers.favicon = (data, callback) => {
  ...
  if (data.method === 'get') {
    ...
    helpers.getStaticAsset('favicon.ico', (err, dataFavicon) => {
      if (!err && dataFavicon) {
        // Callback the data
    ...
    if (trimmedAssetName.length > 0) {
      ...
      helpers.getStaticAsset(trimmedAssetName, (err, dataStaticAsset) => {
        if (!err && dataStaticAsset) {
          ...
          // Callback the data
          callback(200, dataStaticAsset, contentType);
        } else {
          callback(404);
        }
      });
